...
from utils import precompute_freqs_cis, apply_rotary_emb, generate_att_mask
...
class GroupQueryAttention(nn.Module):
    def __init__(self, hidden_dim, n_head, n_group, bias=False, dropout=0.1, max_seq_len=1024):
...
x = torch.randn(3, 32, 4096)
m = MultiheadAttention(hidden_dim=4096, n_head=32)
m(x, mask=generate_att_mask(32, x.device))
